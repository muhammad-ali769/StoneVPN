...
public class MainActivity extends UIActivity implements TrafficListener, VpnStateListener, RegionChooserDialog.RegionChooserInterface {
  ...
  //  @BindView(R.id.uploading_graph)
   ...
   //@BindView(R.id.vpn_world_animation)
    protected LottieAnimationView vpn_world_animation;
            ...
            public void success(@NonNull Boolean aBoolean) {
                if (aBoolean) {
                    ...
                    UnifiedSDK.getInstance().getVPN().start(new SessionConfig.Builder()
                        ...
                        @Override
                        public void complete() {
                            Toast.makeText(MainActivity.this, "VPN Connected completed", Toast.LENGTH_SHORT).show();
                            ...
                            vpn_world_animation.playAnimation();
                            hideConnectProgress();
                            startUIUpdateTask();
                        }
    ...
    protected void disconnectFromVnp() {
        ...
        UnifiedSDK.getInstance().getVPN().stop(TrackingConstants.GprReasons.M_UI, new CompletableCallback() {
            ...
            public void complete() {
                ...
                vpn_world_animation.pauseAnimation();
                hideConnectProgress();
                stopUIUpdateTask();
            }
